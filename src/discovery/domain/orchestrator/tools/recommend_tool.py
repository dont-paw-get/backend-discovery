...
class RecommendBooksTool:
    ...
    async def recommend(self, query: str, count: int = 1) -> str:
    ...
    def as_tool(self) -> Any:
        ...
        async def recommend_books_tool(query: str, count: int = 1) -> str:
            ...
            Args:
                ...
                count: 추천할 도서 권수 (기본값: 1, 1~5권 범위).
            """
            return await self.recommend(query=query, count=count)
