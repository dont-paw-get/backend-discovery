...
CAT_LIBRARIAN_PROMPT = (
    ...
    "10. 국내 출간 및 최신성 제한: 국내 서점(알라딘 등)에서 검색 가능한 "
    "정식 국내 출간(정발) 도서만 추천하세요. 국내에 정발본이 없는 해외 원서는 "
    "추천하지 마세요. 또한 **2000년 이후에 국내에서 출간된 도서만** 추천하고, "
    "그 이전에 출간된 고전문학·고전소설(예: 셰익스피어, 도스토예프스키, 톨스토이 등 "
    "저작권 만료 고전)은 추천하지 마세요."
)
